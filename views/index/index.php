            ...
            <div class="col-xs-12 col-md-7 no-margin">
                ...
                <div class="row no-margin">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                            <img alt="<?php echo $data['all'][$i]->title ?>" src="http://<?php echo $data['all'][$i]->cover ?>" data-echo="http://<?php echo $data['all'][$i]->cover ?>" />
                            </div>
                            <div class="body">
            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div id="best-seller-single-product-slider" class="single-product-slider owl-carousel">
                        ...
                        <img alt="http://<?php echo $last->title ?>" src="<?php echo $last->cover ?>" data-echo="http://<?php echo $last->cover ?>" />
                        <!---coverbig-->
                            </a>
                    ...
                    <div class="gallery-thumbs clearfix">
                        <ul>
                        <li><a class="horizontal-thumb active" data-target="#best-seller-single-product-slider" data-slide="0" href="#slide1"><img alt="<?php echo $last->title ?>" src="http://<?php echo $last->cover ?>" data-echo="http://<?php echo $last->cover ?>" /></a></li>
                        <?php foreach ((array)json_decode($last->pics, true) as $key => $pic): ?>
                            <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="<?php echo $key+1; ?>" href="#slide<?php echo $key+2; ?>"><img alt="" src="http://<?php echo $pic ?>" data-echo="http://<?php echo $pic ?>" /></a></li>
                        <?php endforeach; ?>
                        </ul>
                    </div><!-- /.gallery-thumbs -->
